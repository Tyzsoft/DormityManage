...
<div class="admin-content">
   ...
   <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        ...
        <form class="am-form am-form-horizontal" id="form1" name="form1" action="sys_updateSuccess" method="post">
            <input type="hidden" id="sysid"  name="sysid" value="<s:property value="model.sid"/>"  />
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 / Name</label>
            <div class="am-u-sm-9">
              <input type="text" id="name"  name="name" value="<s:property value="model.name"/>" placeholder="输入你的姓名 " />
              <input type="hidden" id="sid"  name="sid" value="<s:property value="model.sid"/>" placeholder="输入你的姓名 " />
               <input type="hidden" id="pwd"  name="pwd" value="<s:property value="model.pwd"/>" placeholder="输入你的姓名 " />
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
             <s:if test="model.name == '1'.toString()">
        	...
        	<input type="radio" name="gender" value="1" >
        			男
     		<input type="radio" name="gender" value="0"  style="margin-left: 50px;" checked>
        			女
        	</s:else>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="phone" name="telephone" placeholder="输入你的电话号码" value="<s:property value="model.telephone"/>">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="card" name="card"  placeholder="输入你的身份证号" value="<s:property value="model.card"/>" >
            </div>
          </div>
            ...
            <select data-am-selected="{btnSize: 'sm'}" name="bname" >
          		...
          		<s:if test="model.building.name== #p.name">
          		<option value="<s:property value='#p.name'/>" selected>
		 ...
		 <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="address" name="address" placeholder="输入你的地址" readonly value="<s:property value="model.address"/>">
            </div>
	       </div>
