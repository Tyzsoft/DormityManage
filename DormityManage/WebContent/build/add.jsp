...
<div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        ...
        <form class="am-form am-form-horizontal" id="form1" name="form1" action="build_addbuild" method="post">
          <div class="am-form-group">
         ...
         <div class="am-g am-margin-top-sm" style="margin-left: 2px;">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end" style="width:492px;">
              <textarea rows="4" id="introduction" name="introduction" placeholder="输入内容 "></textarea>
            </div>
          </div>
