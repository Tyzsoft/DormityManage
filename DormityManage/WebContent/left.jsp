...
<body>
	 <ul class="am-list admin-sidebar-list">
		...
		<li><a href="sys_index?page=1" target="mainFrame"><span class="am-icon-table">宿舍管理员管理</span> </a></li>
        <li><a href="stu_findAll?page=1" target="mainFrame"><span class="am-icon-table" >学生管理</span> </a></li>
        <li><a href="build_findAll?page=1" target="mainFrame"><span class="am-icon-pencil-square-o" ></span> 宿舍楼管理</a></li>
